...
public class LoggedLeftPanel extends JPanel {
        ...
        public LoggedLeftPanel(Controller controller) {
            ...
            logoPanel.setPreferredSize(new Dimension((int)(Globals.windowWidth / 4), (int)(Globals.windowHeight / 3)));
            logoPanel.setBackground(Globals.BLUE);
            
            // WHITE panel
            JPanel whitePanel = new JPanel();
            whitePanel.setPreferredSize(new Dimension((int)(Globals.windowWidth / 5), (int)(Globals.windowHeight / 5)));
            ...
            bottomPanel.setPreferredSize(new Dimension((int)(Globals.windowWidth / 4), (int)(2 * Globals.windowHeight / 3)));
            bottomPanel.setLayout(new BorderLayout());
            
            JPanel cacc = new JPanel();
            cacc.setBorder(Globals.border(Globals.DARKBLUE, 1));
            cacc.setBackground(Globals.DARKBLUE);
            cacc.setPreferredSize(new Dimension((int)Globals.windowWidth / 5, (int)Globals.windowHeight / 13));
