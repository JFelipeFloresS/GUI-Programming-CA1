...
public class CustomerMain extends JPanel {
        ...
        public CustomerMain(Controller controller) {
            ...
            searchPanel.setPreferredSize(Globals.loginPanelDimension);
            ...
            Globals.barberName = new JTextField(8);
            topSearchName.add(new JLabel("By name:"));
            topSearchName.add(Globals.barberName);
            ...
            topSearchLocation.add(Globals.allLocationsBox);
            ...
            nextBookingPanel.setPreferredSize(Globals.loginPanelDimension);
            ...
            centerNext.setPreferredSize(Globals.paddingX5);
            ...
            rightNextBooking.setPreferredSize(Globals.paddingX1);
            ...
            viewBookings.setFont(Globals.smallFont);
            cancelBooking.setFont(Globals.smallFont);
        }
    }